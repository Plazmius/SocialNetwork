    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.UserProfiles", t => t.FollowedUser_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Follows", "User_Id", "dbo.UserProfiles");
            DropForeignKey("dbo.Follows", "FollowedUser_Id", "dbo.UserProfiles");
